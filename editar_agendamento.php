...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt_paciente->execute([
            ':nome_completo' => $_POST['nome_completo'], ':cpf' => $_POST['cpf'], ':email' => $_POST['email'], 
            ':data_nascimento' => $_POST['data_nascimento'], ':genero' => $_POST['genero'], ':pronomes' => $_POST['pronomes'], 
            ':estado_civil' => $_POST['estado_civil'], ':cep' => $_POST['cep'], ':logradouro' => $_POST['logradouro'], 
            ':numero' => $_POST['numero'], ':complemento' => $_POST['complemento'], ':bairro' => $_POST['bairro'], 
            ':localidade' => $_POST['localidade'], ':uf' => $_POST['uf'], ':telefone' => $_POST['telefone'], 
            ':contato_emergencia_nome' => $_POST['contato_emergencia_nome'], ':telefone_emergencia' => $_POST['telefone_emergencia'], 
            ':condicao_saude' => $_POST['condicao_saude'], ':tipo_sanguineo' => $_POST['tipo_sanguineo'], 
            ':historico_familiar' => $_POST['historico_familiar'], ':alergias' => $_POST['alergias'], 
            ':medico_responsavel' => $_POST['medico_responsavel'], ':observacoes' => $_POST['observacoes'],
            ...
            <div class="col-md-3">
                <div class="card mb-4 shadow-sm border-0">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="editar-paciente.php" class="list-group-item list-group-item-action active border-0">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="editar-paciente.php?id=<?= $paciente['id'] ?>" method="POST" class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" class="form-control" id="data_nascimento" name="data_nascimento" value="<?= htmlspecialchars($paciente['data_nascimento'] ?? '') ?>">
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="condicao_saude" name="condicao_saude" value="<?= htmlspecialchars($paciente['condicao_saude'] ?? '') ?>">
                            </div>
